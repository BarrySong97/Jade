...
pubDate: "2025-08-15"
heroImage: "https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/30f46e89f6d7d768a29b0b38eda3f77bd7367b21313204610a200a0c32c83907.png"
---
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/showcase1-2.png)
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode1-2.png)
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode2-1.png)

在 **Configuration** 模块我们可以看到 **Debug/Release/Profile** 分别对应不同环境下打包的一些参数。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode3-1.png)
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode4-1.png)
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode5-1.png)

接着点击**加号**，然后添加一个环境变量 **APP_DISPLAY_NAME**，根据不同 **Build Configuration**，设置不一样的名字。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode7-1.png)



![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode8-1.png)
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode9-1.png)

### 4. 配置 Bundle Identifier

我们现在开始为不同的配置设置不同的 **Bundle ID**。点击旁边的 **Targets** → **Runner**，然后点击 **General**。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode10-1.png)

之后我们再去看到下面有个 **Identity**，我们看到有个 **Bundle Identifier**，然后旁边有一个**箭头**，我们点击一下。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode11-1.png)

点进去后，会看到有不同的 **Bundle Identifier** 配置项，我们为每个环境填入**不同的** **Bundle ID** 即可。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode12-1.png)
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode13-1.png)

点击右下角的**加号**。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode14-1.png)

选择默认的 **Runner**，然后我们输入新的名字，比如 **dev**，然后点击 **OK** 创建。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode15-1.png)

然后我们退出来之后，我们再点击 **Runner**，点击 **Edit Scheme**。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode16-1.png)

我们先选择我们刚刚创建的 **Scheme**。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode17-1.png)

接着我们点击左边的 **Run**，**Build Configuration** 改成 **Debug_dev**。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode18-1.png)

下面的 **Archive** 也是一样的，切换成 **Release_dev**。

![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/xcode19-1.png)
...
![](https://pub-6fcfe1e3fe954d73917791d34e36c699.r2.dev/vscode1-1.png)
