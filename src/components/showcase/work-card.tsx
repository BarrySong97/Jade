 ...
 * @role    被 works.tsx 在 WORKS.map 中逐个渲染；纯展示，背景色由 placeholderBg(theme,p) 取自调色板
 * @deps    本目录 works-data(Work 类型、placeholderBg、Theme)
...
import { type Work, placeholderBg, type Theme } from "./works-data";
  ...
  return (
    <figure className="mb-3 inline-block w-full break-inside-avoid">
      <div
        ...
        style={{ background: placeholderBg(theme, work.p), aspectRatio: String(work.ar) }}
      >
