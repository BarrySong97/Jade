 ...
 * @deps    本目录 works-data(INTRO)、@/lib/site(PROFILE)
 * @gotcha  姓名对齐首页大标题(`clamp(26px,3.6vw,36px)`/`font-semibold`),取 PROFILE.name 与首页同源;自述对齐首页简介(`15px`/`leading-[1.7]`),通篇 `--fg-2`。令牌见 src/styles/showcase.css
 */
