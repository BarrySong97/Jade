...
import { List, X, ChevronUp, ArrowUpCircle } from "lucide-react";
import { AnimatePresence, motion } from "motion/react";
import { AuthorCard, type AuthorInfo } from "./author-card";
...
const MobileToc = ({ headings, author, className }: MobileTocProps) => {
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4">
              ...
              {author && (
                <>
                  <AuthorCard author={author} className="mb-0" />
